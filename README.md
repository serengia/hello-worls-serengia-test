...
Your task is to return "Hello world" string! That's all! Be careful with capital letters though - the string must be exactly the same as in this description.
